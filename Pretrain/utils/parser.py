...
def get_args():
    ...
    # joint mae arguments
    parser.add_argument('--design', type=str, metavar='MODEL',
                    help='type of design')
    # mae arguments
    ...
    parser.add_argument('--start_ckpts_img', type = str, default=None, help = 'reload used ckpt path')
    parser.add_argument('--img_size', type = str, default=(256, 352), help = 'size of the image branch')
    # pointmae arguments
    parser.add_argument(
        '--config', 
        type = str, 
