...
def do_train(
    ...
    wandb.login(key="d867b9f54f0d3cca85ceaf245429da29dced6012")
...
def main(local_rank, args):
    ...
    # if not args.test_only and args.train_subset:
    #     subset_size = int(len(datasets['train']) / 5)
    #     _ = len(datasets['train']) - subset_size
    #     datasets['train'], _ = torch.utils.data.random_split(datasets['train'], [subset_size, _])
