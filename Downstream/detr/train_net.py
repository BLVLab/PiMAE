...
def main(args):
    ...
    if 'scannet' in cfg.DATASETS.TRAIN[0]:
        register_coco_instances("scannet_train", {}, os.path.join("/home/ubuntu/pimae/data/scannet-frames", "scannet_objdet_train.json"), "/home/ubuntu/pimae/data/scannet-frames/train")
        register_coco_instances("scannet_val", {}, os.path.join("/home/ubuntu/pimae/data/scannet-frames", "scannet_objdet_val.json"),  "/home/ubuntu/pimae/data/scannet-frames/val")
